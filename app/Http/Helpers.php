...
function translate($key, $lang = null){
    ...
    if($translation_locale != null){
        return $translation_locale->lang_value ? $translation_locale->lang_value : $key ;
    }
    else {
        return $translation_def->lang_value ? $translation_def->lang_value : $key ;
    }
}
