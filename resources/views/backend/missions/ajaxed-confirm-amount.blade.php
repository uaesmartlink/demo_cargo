        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    @else
                        <input type="number" class="form-control" @if($mission->getOriginal('type') ==  \App\Mission::DELIVERY_TYPE && $mission->status_id == \App\Mission::RECIVED_STATUS) value="{{ $shipment->shipping_cost + $shipment->tax + $shipment->insurance }}" @else value="{{$mission->amount}}" @endif name="amount" disabled/>
                    @endif
                </div>
            </div>
