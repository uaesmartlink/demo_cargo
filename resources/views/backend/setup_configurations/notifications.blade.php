        ...
        <div class="col-md-8">
            ...
            <div class="card card-custom mb-5">
                <div class="card-header">
                    <h3 class="card-title">{{translate('Server Key')}}</h3>
                </div>
                
                    <form class="form-horizontal" id="kt_form_1" action="{{ route('server_key.update') }}" method="POST">
                        <div class="card-body">
                            @csrf
                            
                            <div class="row">
                                <div class="form-group  col-md-12">
                                    <label class="control-label">{{translate('Server Key')}}</label>
                                    <input type="text" class="form-control" name="Server_Key" value="{{\App\BusinessSetting::where('type', 'server_key')->first()->key}}" placeholder="{{ translate('Server Key') }}">
                                </div>
                            </div>
