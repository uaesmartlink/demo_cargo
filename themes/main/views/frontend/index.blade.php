        ...
        <section id="about" class="single-feature padding mt-n5">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6 text-sm-left text-center wow fadeInLeft" style="text-align: inherit !important;" data-wow-delay="300ms">
            ...
            <div class="row" style="text-align: inherit !important;">
                <div class="col-lg-6 col-md-7 col-sm-12">
                    <div class="heading-title bottom30 wow fadeInLeft" data-wow-delay="200ms">
                        ...
                        <h2 class="bottom30 darkcolor font-normal ">{{get_setting_by_lang('home_msection_htitle')}}</h2>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="feedback-slides">
                            <div class="client-thumbnails">
                                <div>
                                    @forelse (json_decode(get_setting_by_lang('home_testimonials_images'), true) as $key => $value)
                                        <div class="item">
                                            <div class="img-fill">
                                                <img src="{{$home_testimonials_img ? url('public/'.$home_testimonials_img[$key]->file_name ) : ' '}}" alt="client">
                                            </div>
                                            <div class="title">
