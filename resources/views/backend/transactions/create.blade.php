                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 select-captain" name="captain">
                                        ...
                                        @foreach($captains as $captain)
                                            @php
                                                $amount = App\Transaction::where('captain_id', $captain->id)->orderBy('created_at','desc')->sum('value');
                                            @endphp
                                            <option value="{{$captain->id}}">{{$captain->name}} - Ammount: ({{ $amount }}AED)</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 select-client" name="client">
                                        ...
                                        @foreach($clients as $client)
                                            @php
                                                 $amount = App\Transaction::where('client_id', $client->id)->orderBy('created_at','desc')->sum('value');
                                            @endphp
                                            <option value="{{$client->id}}">{{$client->name}} - Ammount: ({{ $amount }}AED)</option>
                                        @endforeach
