                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rec_name" placeholder="{{translate('Receiver Name')}}" name="Shipment[reciver_name]" class="form-control" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rec_phone" placeholder="{{translate('Receiver Phone')}}" name="Shipment[reciver_phone]" class="form-control" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="rec_address" type="text" placeholder="{{translate('Receiver Address')}}" name="Shipment[reciver_address]" class="form-control" />
...
$('input[type=text]').on('wheel', function(e){
    return false;
});
$('input[type=number]').on('wheel', function(e){
    ...
    document.getElementById('code').addEventListener('keydown', function(event) {
        ...
        document.getElementById('rec_name').focus(); // set focus to fieldB
        }
    });
  ...
  document.getElementById('to-area').addEventListener('keydown', function(event) {
    if (event.key === 'Tab') {
      event.preventDefault(); // prevent default tab behavior
