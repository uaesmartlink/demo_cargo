...
<div class="mb-2 row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-danger">{{ translate('Please be carefull when you are configuring. For incorrect configuration you will get error at the time of order place, new registration, sending newsletter.') }}</p>
                <h6 class="text-muted">{{ translate('For PayStack') }}</h6>
                <ul class="list-group">
                    <li class="list-group-item text-dark">{{ translate('Set Currency Of System In PayStack Account , ') }}<a href="https://support.paystack.com/hc/en-us/articles/360009973799-Can-I-accept-payments-in-USD-" target="_blank">{{ translate(' See This To Help') }}</a></li>
                    <li class="list-group-item text-dark">{{ translate('Set Callback URL In PayStack Account Ex: https://YOUR_BASE_URL/paystack/payment/callback ,') }}<a href="https://support.paystack.com/hc/en-us/articles/360009881600-Paystack-Test-Keys-Live-Keys-and-Webhooks" target="_blank">{{ translate(' See This To Help') }}</a></li>
                </ul>
