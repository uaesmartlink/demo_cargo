...
<h4 class="mt-4 text-center text-muted">{{translate('Map Mode')}}</h4>
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 text-center h6">{{translate('Map Mode Activation')}}</h3>
            </div>
            <div class="text-center card-body">
                <label class="mb-0 aiz-switch aiz-switch-success">
                    <input data-switch="true" onchange="updateSettings(this, 'map_activation')" type="checkbox" @if(\App\BusinessSetting::where('type', 'map_activation')->first()->value == 1) checked @endif data-on-text="{{translate('Enabled')}}" data-handle-width="100" data-off-text="{{translate('Disabled')}}" data-on-color="success" />
                    <span class="slider round"></span>
                </label>
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    You need to configure Map correctly to enable this feature. <a href="{{ route('google_recaptcha.index') }}">Configure Now</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="mb-3 col-lg-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 text-center h6">{{translate('Invoice Payment Activation')}}</h3>
            </div>
            <div class="text-center card-body">
                <div class="clearfix">
                    <img class="float-left" src="{{ static_asset('assets/img/cards/cod.png') }}" height="30">
                    ...
                    <label class="float-right mb-0 aiz-switch aiz-switch-success">
                        <input data-switch="true" onchange="updateSettings(this, 'invoice_payment')" type="checkbox" @if(\App\BusinessSetting::where('type', 'invoice_payment')->first()->value == 1) checked @endif data-on-text="{{translate('Enabled')}}" data-handle-width="100" data-off-text="{{translate('Disabled')}}" data-on-color="success" />
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
